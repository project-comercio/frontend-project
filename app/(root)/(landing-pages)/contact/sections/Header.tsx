			...
			<div className="absolute z-30 w-full max-w-2xl lg:max-w-6xl flex lg:flex-row flex-col gap-8 lg:gap-16 px-4 py-16 sm:p-12 lg:p-20">
				<article className="w-full bg-opacity-100">
					...
					<p className="text-white mt-4 lg:text-base text-sm text-center lg:text-left">
						Tire dúvidas com nossos profissionais enviando um email através do
						formulário ao lado, além disso, você também pode contribuir com
						ideias!
					</p>
					<div className="text-center lg:text-left mt-10">
						<a
							href="https://api.whatsapp.com/send?phone=19982880116"
							target="_blank"
							rel="noopener noreferrer"
							className="relative px-10 py-5 bg-gray-900 rounded-2xl transition-colors duration-300 ease-in-out hover:bg-principal flex  items-center "
						>
							<FaWhatsapp className="text-3xl md:text-3xl mr-3 md:mr-3" />
							<span className="text-white text-xl md:text-1xl font-semibold ">
								FALE CONOSCO
							</span>
						</a>
					</div>
