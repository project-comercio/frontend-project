...
export default function Header() {
    ...
    <section className="relative w-full flex justify-between lg:min-h-[720px]">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("https://images.unsplash.com/photo-1535957998253-26ae1ef29506?q=80&w=1336&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")`
        }}
      />
    </section>
  )
