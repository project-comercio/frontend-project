...
export const Collaborator: React.FC<CollaboratorCardProps> = ({
  ...
  return (
    <section className="bg-white h-full py-8 px-4 w-full border flex flex-col items-center border-slate-200 drop-shadow-md rounded-md">
      ...
      <article className="mt-6 flex w-full flex-wrap gap-3">
        {colaborator.github ? (
