      ...
      <main className="lg:px-12 px-4 min-h-[62vh] pt-20">
            ...
            <div className="flex justify-between">
              <div className="w-full items-center flex flex-col">
                <article className="w-full max-w-md">
                  ...
                  <ul className="flex flex-col gap-3 w-full mt-8">
                  ...
                  <div className="mt-8 flex gap-4 lg:gap-8 items-center">
                    ...
                    <Link
                      href={"#"}
                      className="text-principal transition-all duration-30 text-xs lg:text-sm hover:text-indigo-600"
                    >
                      Ver dicas
                    </Link>
                  </div>
        ...
        <motion.section initial="hidden" animate="visible" variants={slideInFromTop}  className="w-full py-12 lg:py-20 flex flex-col items-center">
          <div className="w-full max-w-6xl">
            ...
            <div className="flex mt-12 gap-8 justify-center w-full">
              <div className="max-w-[290px] w-full bg-slate-100 rounded-lg lg:p-6 p-4 cursor-pointer transition-all duration-500 hover:scale-105">
        ...
        <motion.section initial="hidden" animate="visible" variants={slideInFromRight(1)}  className="w-full py-12 lg:py-20 flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl flex justify-between gap-12 lg:mt-20 mt-12">
            <article className="flex-1 w-full">
              <span className="text-principal text-xs lg:text-sm uppercase font-semibold">
                Marketing
              </span>
        ...
        <motion.section initial="hidden" animate="visible" variants={slideInFromTop}  className="w-full flex flex-col items-center">
          <div className="w-full max-w-6xl">
            <h2 className="mt-24 mb-20 w-full text-center font-[500] text-4xl cursor-default">
              Veja mais de{" "}
              <span className="font-[500] text-transparent text-4xl bg-clip-text bg-gradient-to-r from-[#6C47FF] to-[#5BC5EF]">
                100 artigos
              </span>{" "}
              sobre o que está <br />
              <span className="font-[500] text-transparent text-4xl bg-clip-text bg-gradient-to-r from-[#6C47FF] to-[#5BC5EF]">
