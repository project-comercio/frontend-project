  ...
  return (
    <section className="w-full bg-white rounded-lg border border-slate-200">
      <div
        ...
        style={{
          backgroundImage: `url("https://e0.pxfuel.com/wallpapers/881/773/desktop-wallpaper-hex-abstract-material-design-abstract-background-and-material-ui.jpg")`
        }}
      />
      <div className="p-4 lg:p-8 w-full">
        ...
        <article className="mt-4">
          <h2 className="text-sm lg:text-base font-semibold items-center flex gap-1">
            {userData?.firstname} {userData?.lastname} -{' '}
            <span className="text-xs lg:text-xs text-principal font-medium">
              10 seguidores
            </span>
          </h2>
