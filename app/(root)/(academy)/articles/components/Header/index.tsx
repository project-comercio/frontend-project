	...
	return (
		<section className="relative w-full flex justify-between lg:min-h-[720px]">
			<div className="lg:w-[50%] z-20 relative bg-gradient-to-r from-slate-950 to-slate-900 opacity-95 flex justify-end">
				<article className="w-full px-4 py-16 sm:p-12 lg:p-20 max-w-2xl">
					...
					<p className="text-white mt-4 lg:text-base text-sm text-center lg:text-left">
						Veja nossos artigos, cursos e matérias de como valorizar a sua marca
						e se destacar cada vez mais o seu comércio no seu ramo.
					</p>
			...
			<div
				...
				style={{
					backgroundImage: `url("https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")`,
				}}
			/>
		</section>
	);
