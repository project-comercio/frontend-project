...
export const PortugalFlagIcon: React.FC<IconProps> = props => (
  <svg
    aria-hidden="true"
    height="800px"
  ...
  >
    ...
    <path
      ...
      fill="#FFCC4D"
    ></path>
    <path d="M11 13v7a4 4 0 0 0 8 0v-7h-8z" fill="#D52B1E"></path>
    <path d="M12 14v6a3 3 0 0 0 6 0v-6h-6z" fill="#FFF"></path>
    <path d="M13 17h4v2h-4z" fill="#829ACD"></path>
    <path d="M14 16h2v4h-2z" fill="#829ACD"></path>
    <path
